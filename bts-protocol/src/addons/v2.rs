...
pub struct MenuEntry {
    ...
    /// Concise human-facing name used by administrative clients.
    pub label: String,
    /// Natural-language phrase spoken after the generated digit.
    ///
    /// When omitted, Telephony derives speech from `label`.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub spoken_label: Option<String>,
    /// How the spoken label completes "Press <digit> ...".
    #[serde(default)]
    pub speech_style: MenuSpeechStyle,
    pub action: ActionId,
    pub order: u16,
}
...
#[serde(rename_all = "snake_case")]
pub enum MenuSpeechStyle {
    /// Render "Press <digit> for <spoken label>."
    #[default]
    Choice,
    /// Render "Press <digit> to <spoken label>."
    Instruction,
}
...
/// A BTS addon that can run against any Addon API v2 context implementation.
#[async_trait]
