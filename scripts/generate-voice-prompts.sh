...
generate_prompt "press-0-configuration" "Press zero for configuration."
generate_prompt "press-hash-confirm" "Press hash to confirm."
generate_prompt "no-terminals-online" "No terminals are online."
generate_prompt "select-terminal" "Select a terminal target."
generate_prompt "target-selected" "Target selected."
generate_prompt "target-unavailable" "The selected target is unavailable."
generate_prompt "invalid-selection" "That selection is not valid."
generate_prompt "returned-to-addon" "Returning to the previous service."
