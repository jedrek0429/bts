...
pub const CORE_ADMIN_ADDONS_PATH: &str = "{core_prefix}/admin/addons";
pub const CORE_ADMIN_ADDON_PATH: &str = "{core_prefix}/admin/addons/{{addon}}";
pub const CORE_ADMIN_ADDON_ENABLED_PATH: &str = "{core_prefix}/admin/addons/{{addon}}/enabled";
